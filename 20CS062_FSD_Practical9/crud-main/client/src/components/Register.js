...
const Register = () => {
    ...
    return (
        <div className="container" style={{fontFamily:"verdana", fontWeight:"bold", }}>
            <NavLink to="/home" style={{textDecoration:"none", color:"#F8C471", fontWeight:"bold"}}>Home</NavLink>
            <form className="mt-4">
                <div className="row">
                    ...
                    <button type="submit" onClick={addinpdata} class="btn btn-primary" style={{backgroundColor:"#F8C471",boxShadow:"7px", border:"5px", fontWeight:"bold"}}>Add Employee</button>
                </div>
            </form>
        </div>
    )
