   ...
   const {updata, setUPdata} = useContext(updatedata)
    ...
    return (
        <div className="container" style={{fontFamily:"verdana", fontWeight:"bold", }}>
            <NavLink to="/home" style={{textDecoration:"none", color:"#F8C471", fontSize:"20px"}}>Home</NavLink>
            <h3>Edit Details</h3>
            <form className="mt-4">
                <div className="row">
                    ...
                    <button type="submit" onClick={updateuser} class="btn btn-primary" style={{backgroundColor:"#F8C471", border:"5px", fontWeight:"bold"}}>Update</button>
                </div>
            </form>
        </div>
    )
